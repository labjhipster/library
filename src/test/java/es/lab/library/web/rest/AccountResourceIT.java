package es.lab.library.web.rest;

import static es.lab.library.web.rest.AccountResourceIT.TEST_USER_LOGIN;
import static org.assertj.core.api.Assertions.assertThat;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import es.lab.library.LibraryApp;
import es.lab.library.config.Constants;
import es.lab.library.domain.User;
import es.lab.library.repository.AuthorityRepository;
import es.lab.library.repository.UserRepository;
import es.lab.library.security.AuthoritiesConstants;
import es.lab.library.service.UserService;
import es.lab.library.service.dto.PasswordChangeDTO;
import es.lab.library.service.dto.UserDTO;
import es.lab.library.web.rest.vm.KeyAndPasswordVM;
import es.lab.library.web.rest.vm.ManagedUserVM;
